...
const FALLBACK_POLICIES = {
  'terms-of-service': {
    ...
    body: `
      <h2>Overview</h2>
      <p>This website is operated by VĒRTEX. Throughout the site, the terms "we", "us" and "our" refer to VĒRTEX. We offer this website, including all information, tools and services available from this site to you, the user, conditioned upon your acceptance of all terms, conditions, policies and notices stated here.</p>
  ...
  'refund-policy': {
    ...
    body: `
      <h2>Returns</h2>
      <p>We want you to love your VĒRTEX purchase. If for any reason you're not completely satisfied, we accept returns within 30 days of delivery for a full refund to your original payment method.</p>
